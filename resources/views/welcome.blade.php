...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hola <strong>[Nombre del Cliente]</strong>,</p>
            <p>Hemos recibido tu pago exitosamente. Estos son todos los detalles de tu compra:</p>

            <div class="details">
                <p><strong>Fecha de Compra:</strong> [Fecha de Compra]</p>
                <p><strong>Correo Electrónico:</strong> [Correo Electrónico]</p>
                <p><strong>Número de Orden:</strong> [Número de Orden]</p>
                <p><strong>Método de Pago:</strong> [Método de Pago]</p>
                <p><strong>Estado del Pago:</strong> [Estado del Pago]</p>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>[Cantidad 1]</td>
                            <td>$[Precio Unitario 1]</td>
                            <td>$[Subtotal 1]</td>
                        </tr>
                        <tr>
                            <td>[Nombre del Producto 2]</td>
                            <td>[Cantidad 2]</td>
                            <td>$[Precio Unitario 2]</td>
                            <td>$[Subtotal 2]</td>
                        </tr>
